    ...
    submitData () {
      ...
      this.$axios.post('http://128.199.72.101:3000/api/registrars', {
        ...
        swal({
          ...
          html: 'Kamu telah terdaftar dengan email <b>' + self.formModel.email + '</b>. Ingat selalu email ini, karena pengumuman hasil seleksi akan menggunakan email tersebut. Untuk info lebih lanjut pantau sosial media FLS 2019',
          type: 'success',
